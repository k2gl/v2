...
# Instruction: Copy this file as 'agents.local.md' in this folder.
...
- **READ_ENV_FILES**: "true"  # Check .env without quoting values
- **IGNORE_PATTERNS**: "temp_logs,*.log,*.sqlite"

## Personal Preferences
- **Language**: "Russian"
- **Tone**: "Professional, concise"
- **Verbosity**: "Brief answers with examples when needed"
